  ...
  return (
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            ...
            })(window,document,'script','dataLayer','GTM-W6V6QP62');
          `,
        }} />
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-9TFPGWPMCJ"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', 'G-9TFPGWPMCJ');
            `,
          }}
        />
        {/* End New Google Analytics Tracking Code */}
        {/* Google AdSense */}
        <script 
          async 
      ...
      >
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-W6V6QP62"
            height="0" 
            width="0" 
