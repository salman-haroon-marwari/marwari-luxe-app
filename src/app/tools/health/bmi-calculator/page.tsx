...
// Adding metadata for the BMI calculator tool page - moved outside the client component
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.marwariluxe.com/tools/health/bmi-calculator',
  ...
  alternates: {
    canonical: 'https://www.marwariluxe.com/tools/health/bmi-calculator',
  },
};
