...
export default function BlogSection() {
  ...
  const selectedBlogIds = [
    'health-blog-001',    // Health blog 1
    'health-blog-002',    // Health blog 2
    'beauty-blog-001',    // Beauty blog 1
    'beauty-blog-002',    // Beauty blog 2
    'evergreen-health-001', // Evergreen blog 1
    'evergreen-health-002'  // Evergreen blog 2
  ];
